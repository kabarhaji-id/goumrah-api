...
func main() {
	...
	packageSessionMapper := mapper.NewPackageSessionMapper(embarkationMapper, guideMapper)
	...
	packageSessionService := service.NewPackageSessionService(packageSessionRepository, packageSessionValidator, packageSessionMapper, embarkationRepository, imageRepository, unitOfWork)
