...
func main() {
	...
	packageSessionMapper := mapper.NewPackageSessionMapper(embarkationMapper, guideMapper, flightMapper)
	...
	packageSessionService := service.NewPackageSessionService(packageSessionRepository, packageSessionValidator, packageSessionMapper, embarkationRepository, imageRepository, flightRouteRepository, flightRepository, airlineRepository, airportRepository, unitOfWork)
