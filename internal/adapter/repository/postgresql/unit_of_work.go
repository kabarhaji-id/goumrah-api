...
func (factory factoryPostgresql) NewLandingTestimonialContentRepository() repository.LandingTestimonialContentRepository {
	return NewLandingTestimonialContentRepository(factory.db)
}

func (factory factoryPostgresql) NewLandingTestimonialContentReviewRepository() repository.LandingTestimonialContentReviewRepository {
	return NewLandingTestimonialContentReviewRepository(factory.db)
}
