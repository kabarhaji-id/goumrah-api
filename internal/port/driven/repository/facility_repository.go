...
type FacilityRepository interface {
	Create(ctx context.Context, facility entity.Facility) (entity.Facility, error)
	...
	Update(ctx context.Context, id int64, facility entity.Facility) (entity.Facility, error)
