...
type AddonCategoryRepository interface {
	Create(ctx context.Context, image entity.AddonCategory) (entity.AddonCategory, error)
	...
	Update(ctx context.Context, id int64, image entity.AddonCategory) (entity.AddonCategory, error)
