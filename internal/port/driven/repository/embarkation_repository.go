...
type EmbarkationRepository interface {
	Create(ctx context.Context, embarkation entity.Embarkation) (entity.Embarkation, error)
	...
	Update(ctx context.Context, id int64, embarkation entity.Embarkation) (entity.Embarkation, error)
